...
public class AddDebuggerKeywordBreakpointAction implements IWorkbenchWindowActionDelegate, IViewActionDelegate {
	...
	public void run(IAction action) {
		JSDebuggerKeywordBreakpoint.createBreakpoint();
	}
