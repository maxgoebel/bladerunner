...
public class TypedElementSelectionValidator implements ISelectionStatusValidator {
	...
	private IStatus fgErrorStatus= new Status(IStatus.ERROR, MozillaDebugUIPlugin.PLUGIN_ID, ""); //$NON-NLS-1$
	private IStatus fgOKStatus= new Status(IStatus.OK, MozillaDebugUIPlugin.PLUGIN_ID, "");
