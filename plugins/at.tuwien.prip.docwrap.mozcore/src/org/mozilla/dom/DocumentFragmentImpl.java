...
public class DocumentFragmentImpl extends NodeImpl implements org.w3c.dom.DocumentFragment
{
    ...
    /***************************************************************
     *
     * DocumentFragment implementation code
     *
     ***************************************************************/

    public DocumentFragmentImpl(nsIDOMDocumentFragment mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMDocumentFragment getInstanceAsnsIDOMDocumentFragment()
    {
        if (moz==null)
            ...
            return (nsIDOMDocumentFragment) moz.queryInterface(nsIDOMDocumentFragment.NS_IDOMDOCUMENTFRAGMENT_IID);
    }
