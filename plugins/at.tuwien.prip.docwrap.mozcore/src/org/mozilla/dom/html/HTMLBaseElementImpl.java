...
public class HTMLBaseElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLBaseElement
{
    ...
    /***************************************************************
     *
     * HTMLBaseElement implementation code
     *
     ***************************************************************/

    public HTMLBaseElementImpl(nsIDOMHTMLBaseElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLBaseElement getInstanceAsnsIDOMHTMLBaseElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLBaseElement) moz.queryInterface(nsIDOMHTMLBaseElement.NS_IDOMHTMLBASEELEMENT_IID);
    }
    ...
    public void setHref(final String href)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLBaseElement().setHref(href);
        }};
    ...
    public void setTarget(final String target)
    {
        //METHOD-BODY-START - autogenerated code
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLBaseElement().setTarget(target);
        }};
        ThreadProxy.getSingleton().syncExec(r);
        //METHOD-BODY-END - autogenerated code
    }
    ...
    public String getHref()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLBaseElement().getHref();
            return result;
        }};
    ...
    public String getTarget()
    {
        //METHOD-BODY-START - autogenerated code
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLBaseElement().getTarget();
            return result;
        }};
        return ThreadProxy.getSingleton().syncExec(c);
        //METHOD-BODY-END - autogenerated code
