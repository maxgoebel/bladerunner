...
public class HTMLFrameSetElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLFrameSetElement
{
    ...
    /***************************************************************
     *
     * HTMLFrameSetElement implementation code
     *
     ***************************************************************/

    public HTMLFrameSetElementImpl(nsIDOMHTMLFrameSetElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLFrameSetElement getInstanceAsnsIDOMHTMLFrameSetElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLFrameSetElement) moz.queryInterface(nsIDOMHTMLFrameSetElement.NS_IDOMHTMLFRAMESETELEMENT_IID);
    }
    ...
    public void setRows(final String rows)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLFrameSetElement().setRows(rows);
        }};
    ...
    public String getCols()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLFrameSetElement().getCols();
            return result;
        }};
    ...
    public String getRows()
    {
        //METHOD-BODY-START - autogenerated code
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLFrameSetElement().getRows();
            return result;
        }};
        return ThreadProxy.getSingleton().syncExec(c);
        //METHOD-BODY-END - autogenerated code
    ...
    public void setCols(final String cols)
    {
        //METHOD-BODY-START - autogenerated code
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLFrameSetElement().setCols(cols);
        }};
        ThreadProxy.getSingleton().syncExec(r);
        //METHOD-BODY-END - autogenerated code
    }
