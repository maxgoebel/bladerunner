...
public class HTMLModElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLModElement
{
    ...
    /***************************************************************
     *
     * HTMLModElement implementation code
     *
     ***************************************************************/

    public HTMLModElementImpl(nsIDOMHTMLModElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLModElement getInstanceAsnsIDOMHTMLModElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLModElement) moz.queryInterface(nsIDOMHTMLModElement.NS_IDOMHTMLMODELEMENT_IID);
    }
    ...
    public String getDateTime()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLModElement().getDateTime();
            return result;
        }};
    ...
    public String getCite()
    {
        //METHOD-BODY-START - autogenerated code
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLModElement().getCite();
            return result;
        }};
        return ThreadProxy.getSingleton().syncExec(c);
        //METHOD-BODY-END - autogenerated code
    ...
    public void setDateTime(final String dateTime)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLModElement().setDateTime(dateTime);
        }};
    ...
    public void setCite(final String cite)
    {
        //METHOD-BODY-START - autogenerated code
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLModElement().setCite(cite);
        }};
        ThreadProxy.getSingleton().syncExec(r);
        //METHOD-BODY-END - autogenerated code
    }
