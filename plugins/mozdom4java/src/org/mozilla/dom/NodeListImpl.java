...
public class NodeListImpl implements org.w3c.dom.NodeList
{
    ...
    public nsIDOMNodeList getInstanceAsnsIDOMNodeList()
    {
        if (moz==null)
            ...
            return (nsIDOMNodeList) moz.queryInterface(nsIDOMNodeList.NS_IDOMNODELIST_IID);
    }
    ...
    public Node item(final int index)
    {
        ...
        Callable<Node> c = new Callable<Node>() { public Node call() {
            nsIDOMNode result = getInstanceAsnsIDOMNodeList().item(index);
    ...
    public int getLength()
    {
        ...
        Callable<Integer> c = new Callable<Integer>() { public Integer call() {
            long result = getInstanceAsnsIDOMNodeList().getLength();
            return (int) result;
        }};
        return ThreadProxy.getSingleton().syncExec(c);
        //METHOD-BODY-END - autogenerated code
