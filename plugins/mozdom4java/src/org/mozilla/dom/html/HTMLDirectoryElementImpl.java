...
public class HTMLDirectoryElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLDirectoryElement
{
    ...
    /***************************************************************
     *
     * HTMLDirectoryElement implementation code
     *
     ***************************************************************/

    public HTMLDirectoryElementImpl(nsIDOMHTMLDirectoryElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLDirectoryElement getInstanceAsnsIDOMHTMLDirectoryElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLDirectoryElement) moz.queryInterface(nsIDOMHTMLDirectoryElement.NS_IDOMHTMLDIRECTORYELEMENT_IID);
    }
    ...
    public boolean getCompact()
    {
        ...
        Callable<Boolean> c = new Callable<Boolean>() { public Boolean call() {
            boolean result = getInstanceAsnsIDOMHTMLDirectoryElement().getCompact();
            return result;
        }};
    ...
    public void setCompact(final boolean compact)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLDirectoryElement().setCompact(compact);
        }};
