...
public class HTMLHeadingElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLHeadingElement
{
    ...
    /***************************************************************
     *
     * HTMLHeadingElement implementation code
     *
     ***************************************************************/

    public HTMLHeadingElementImpl(nsIDOMHTMLHeadingElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLHeadingElement getInstanceAsnsIDOMHTMLHeadingElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLHeadingElement) moz.queryInterface(nsIDOMHTMLHeadingElement.NS_IDOMHTMLHEADINGELEMENT_IID);
    }
    ...
    public String getAlign()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLHeadingElement().getAlign();
            return result;
        }};
    ...
    public void setAlign(final String align)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLHeadingElement().setAlign(align);
        }};
