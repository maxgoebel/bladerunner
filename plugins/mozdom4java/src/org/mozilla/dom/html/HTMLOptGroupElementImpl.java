...
public class HTMLOptGroupElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLOptGroupElement
{
    ...
    /***************************************************************
     *
     * HTMLOptGroupElement implementation code
     *
     ***************************************************************/

    public HTMLOptGroupElementImpl(nsIDOMHTMLOptGroupElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLOptGroupElement getInstanceAsnsIDOMHTMLOptGroupElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLOptGroupElement) moz.queryInterface(nsIDOMHTMLOptGroupElement.NS_IDOMHTMLOPTGROUPELEMENT_IID);
    }
    ...
    public void setLabel(final String label)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLOptGroupElement().setLabel(label);
        }};
    ...
    public void setDisabled(final boolean disabled)
    {
        //METHOD-BODY-START - autogenerated code
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLOptGroupElement().setDisabled(disabled);
        }};
        ThreadProxy.getSingleton().syncExec(r);
        //METHOD-BODY-END - autogenerated code
    }
    ...
    public String getLabel()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLOptGroupElement().getLabel();
            return result;
        }};
    ...
    public boolean getDisabled()
    {
        ...
        Callable<Boolean> c = new Callable<Boolean>() { public Boolean call() {
            boolean result = getInstanceAsnsIDOMHTMLOptGroupElement().getDisabled();
            return result;
        }};
        return ThreadProxy.getSingleton().syncExec(c);
        //METHOD-BODY-END - autogenerated code
