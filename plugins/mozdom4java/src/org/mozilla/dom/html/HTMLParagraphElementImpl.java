...
public class HTMLParagraphElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLParagraphElement
{
    ...
    /***************************************************************
     *
     * HTMLParagraphElement implementation code
     *
     ***************************************************************/

    public HTMLParagraphElementImpl(nsIDOMHTMLParagraphElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLParagraphElement getInstanceAsnsIDOMHTMLParagraphElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLParagraphElement) moz.queryInterface(nsIDOMHTMLParagraphElement.NS_IDOMHTMLPARAGRAPHELEMENT_IID);
    }
    ...
    public String getAlign()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLParagraphElement().getAlign();
            return result;
        }};
    ...
    public void setAlign(final String align)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLParagraphElement().setAlign(align);
        }};
