...
public class HTMLFieldSetElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLFieldSetElement
{
    ...
    /***************************************************************
     *
     * HTMLFieldSetElement implementation code
     *
     ***************************************************************/

    public HTMLFieldSetElementImpl(nsIDOMHTMLFieldSetElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLFieldSetElement getInstanceAsnsIDOMHTMLFieldSetElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLFieldSetElement) moz.queryInterface(nsIDOMHTMLFieldSetElement.NS_IDOMHTMLFIELDSETELEMENT_IID);
    }
    ...
    public HTMLFormElement getForm()
    {
        ...
        Callable<HTMLFormElement> c = new Callable<HTMLFormElement>() { public HTMLFormElement call() {
            nsIDOMHTMLFormElement result = getInstanceAsnsIDOMHTMLFieldSetElement().getForm();
