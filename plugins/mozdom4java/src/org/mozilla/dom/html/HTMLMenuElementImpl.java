...
public class HTMLMenuElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLMenuElement
{
    ...
    /***************************************************************
     *
     * HTMLMenuElement implementation code
     *
     ***************************************************************/

    public HTMLMenuElementImpl(nsIDOMHTMLMenuElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLMenuElement getInstanceAsnsIDOMHTMLMenuElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLMenuElement) moz.queryInterface(nsIDOMHTMLMenuElement.NS_IDOMHTMLMENUELEMENT_IID);
    }
    ...
    public boolean getCompact()
    {
        ...
        Callable<Boolean> c = new Callable<Boolean>() { public Boolean call() {
            boolean result = getInstanceAsnsIDOMHTMLMenuElement().getCompact();
            return result;
        }};
    ...
    public void setCompact(final boolean compact)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLMenuElement().setCompact(compact);
        }};
