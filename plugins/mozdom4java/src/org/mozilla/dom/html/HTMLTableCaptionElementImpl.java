...
public class HTMLTableCaptionElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLTableCaptionElement
{
    ...
    /***************************************************************
     *
     * HTMLTableCaptionElement implementation code
     *
     ***************************************************************/

    public HTMLTableCaptionElementImpl(nsIDOMHTMLTableCaptionElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLTableCaptionElement getInstanceAsnsIDOMHTMLTableCaptionElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLTableCaptionElement) moz.queryInterface(nsIDOMHTMLTableCaptionElement.NS_IDOMHTMLTABLECAPTIONELEMENT_IID);
    }
    ...
    public String getAlign()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLTableCaptionElement().getAlign();
            return result;
        }};
    ...
    public void setAlign(final String align)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLTableCaptionElement().setAlign(align);
        }};
