...
public class HTMLBRElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLBRElement
{
    ...
    /***************************************************************
     *
     * HTMLBRElement implementation code
     *
     ***************************************************************/

    public HTMLBRElementImpl(nsIDOMHTMLBRElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLBRElement getInstanceAsnsIDOMHTMLBRElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLBRElement) moz.queryInterface(nsIDOMHTMLBRElement.NS_IDOMHTMLBRELEMENT_IID);
    }
    ...
    public String getClear()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLBRElement().getClear();
            return result;
        }};
    ...
    public void setClear(final String clear)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLBRElement().setClear(clear);
        }};
