...
public class HTMLTitleElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLTitleElement
{
    ...
    /***************************************************************
     *
     * HTMLTitleElement implementation code
     *
     ***************************************************************/

    public HTMLTitleElementImpl(nsIDOMHTMLTitleElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLTitleElement getInstanceAsnsIDOMHTMLTitleElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLTitleElement) moz.queryInterface(nsIDOMHTMLTitleElement.NS_IDOMHTMLTITLEELEMENT_IID);
    }
    ...
    public void setText(final String text)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLTitleElement().setText(text);
        }};
    ...
    public String getText()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLTitleElement().getText();
            return result;
        }};
