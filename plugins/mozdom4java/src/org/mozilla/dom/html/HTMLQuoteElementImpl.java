...
import org.mozilla.interfaces.nsIDOMHTMLQuoteElement;
...
public class HTMLQuoteElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLQuoteElement
{
    ...
    {
	return getInstanceAsnsIDOMHTMLQuoteElement();
    }

    /***************************************************************
     *
     * HTMLQuoteElement implementation code
     *
     ***************************************************************/

    public HTMLQuoteElementImpl(nsIDOMHTMLQuoteElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLQuoteElement getInstanceAsnsIDOMHTMLQuoteElement()
    {
        if (moz==null)
            return null;
        else
            return (nsIDOMHTMLQuoteElement) moz.queryInterface(nsIDOMHTMLQuoteElement.NS_IDOMHTMLQUOTEELEMENT_IID);
    }
    ...
    public String getCite()
    {
        ...
        Callable<String> c = new Callable<String>() { public String call() {
            String result = getInstanceAsnsIDOMHTMLQuoteElement().getCite();
            return result;
        }};
    ...
    public void setCite(final String cite)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLQuoteElement().setCite(cite);
        }};
