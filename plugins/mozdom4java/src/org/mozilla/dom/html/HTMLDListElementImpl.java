...
public class HTMLDListElementImpl extends HTMLElementImpl implements org.w3c.dom.html.HTMLDListElement
{
    ...
    /***************************************************************
     *
     * HTMLDListElement implementation code
     *
     ***************************************************************/

    public HTMLDListElementImpl(nsIDOMHTMLDListElement mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMHTMLDListElement getInstanceAsnsIDOMHTMLDListElement()
    {
        if (moz==null)
            ...
            return (nsIDOMHTMLDListElement) moz.queryInterface(nsIDOMHTMLDListElement.NS_IDOMHTMLDLISTELEMENT_IID);
    }
    ...
    public boolean getCompact()
    {
        ...
        Callable<Boolean> c = new Callable<Boolean>() { public Boolean call() {
            boolean result = getInstanceAsnsIDOMHTMLDListElement().getCompact();
            return result;
        }};
    ...
    public void setCompact(final boolean compact)
    {
        ...
        final Runnable r = new Runnable() { public void run() {
            getInstanceAsnsIDOMHTMLDListElement().setCompact(compact);
        }};
