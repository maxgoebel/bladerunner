...
public class CDATASectionImpl extends TextImpl implements org.w3c.dom.CDATASection
{
    ...
    /***************************************************************
     *
     * CDATASection implementation code
     *
     ***************************************************************/

    public CDATASectionImpl(nsIDOMCDATASection mozInst)
    {
        super( mozInst );
    }
    ...
    public nsIDOMCDATASection getInstanceAsnsIDOMCDATASection()
    {
        if (moz==null)
            ...
            return (nsIDOMCDATASection) moz.queryInterface(nsIDOMCDATASection.NS_IDOMCDATASECTION_IID);
    }
