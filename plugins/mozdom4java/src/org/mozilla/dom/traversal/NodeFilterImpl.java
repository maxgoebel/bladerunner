...
public class NodeFilterImpl implements org.w3c.dom.traversal.NodeFilter
{
    ...
    /***************************************************************
     *
     * NodeFilter implementation code
     *
     ***************************************************************/

    protected NodeFilterImpl(nsISupports mozInst)
    {
        moz = mozInst;
    ...
    public nsIDOMNodeFilter getInstanceAsnsIDOMNodeFilter()
    {
        if (moz==null)
            ...
            return (nsIDOMNodeFilter) moz.queryInterface(nsIDOMNodeFilter.NS_IDOMNODEFILTER_IID);
    }
    ...
    public short acceptNode(final Node n)
    {
        ...
        Callable<Short> c = new Callable<Short>() { public Short call() {
            short result = getInstanceAsnsIDOMNodeFilter().acceptNode(mozN);
            return result;
        }};
