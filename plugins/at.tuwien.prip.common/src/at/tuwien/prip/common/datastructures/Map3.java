...
public interface Map3<K1,K2,K3,V> {
     ...
     */
    void putAll(Map3<? extends K1, ? extends K2, ? extends K3, ? extends V> t);
     ...
     */
    Set<Map3.Entry3<K1,K2,K3,V>> entrySet();
