...
public abstract class AbstractMap3<K1,K2,K3,V> implements Map3<K1,K2,K3,V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMap3() {
    }
    ...
    Iterator<Entry3<K1,K2,K3,V>> i = entrySet().iterator();
    if (value==null) {
        while (i.hasNext()) {
        Entry3<K1,K2,K3,V> e = i.next();
        if (e.getValue()==null)
            return true;
        }
    } else {
        ...
        if (key1==null || key2==null || key3==null) {
            while (i.hasNext()) {
                ...
                if (((key1==null && e.getKey1()==null) ||
                    ...
                    ((key3==null && e.getKey3()==null) ||
                     (key3!=null && key3.equals(e.getKey3()))))
                {
                    return true;
                }
            }
    ...
    public V remove(Object key1, Object key2, Object key3) {
        Iterator<Entry3<K1,K2,K3,V>> i = entrySet().iterator();
        Entry3<K1,K2,K3,V> correctEntry = null;
        if (key1==null || key2==null || key3==null) {
     ...
     */
    public void putAll(Map3<? extends K1, ? extends K2, ? extends K3, ? extends V> t) {
        Iterator<? extends Entry3<? extends K1, ? extends K2,  ? extends K3, ? extends V>> i = t.entrySet().iterator();
        while (i.hasNext()) {
            Entry3<? extends K1, ? extends K2,  ? extends K3, ? extends V> e = i.next();
     ...
     */
    transient volatile Set<KeyPair3<K1,K2,K3>> keySet = null;
    ...
    public Set<KeyPair3<K1,K2,K3>> keySet() {
        if (keySet == null) {
            keySet = new AbstractSet<KeyPair3<K1,K2,K3>>() {
                public Iterator<KeyPair3<K1,K2,K3>> iterator() {
                    return new Iterator<KeyPair3<K1,K2,K3>>() {
                        private Iterator<Entry3<K1,K2,K3,V>> i = entrySet().iterator();
                ...
                public int size() {
                    return AbstractMap3.this.size();
                }

                @SuppressWarnings("unchecked")
                public boolean contains(Object k) {
                    if (k instanceof KeyPair3) {
                        KeyPair3<K1,K2,K3> kp = (KeyPair3<K1,K2,K3>) k;
                        return
                            AbstractMap3.this.
                            containsKey(kp.getKey1(), kp.getKey2(), kp.getKey3());
                    }
                    return false;
                }
            };
        ...
        if (values == null) {
            values = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return AbstractMap3.this.containsValue(v);
                }
            };
        }
        return values;
     ...
     */
    public abstract Set<Entry3<K1,K2,K3,V>> entrySet();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Map3))
            return false;
        Map3<K1,K2,K3,V> t = (Map3<K1,K2,K3,V>) o;
        if (t.size() != size())
            return false;
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                V value = e.getValue();
                if (value == null) {
                    if (!(t.get(key1,key2,key3)==null && t.containsKey(key1,key2,key3)))
                        return false;
                } else {
                    if (!value.equals(t.get(key1,key2,key3)))
                        return false;
                }
            }
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbstractMap3<K1,K2,K3,V> result = (AbstractMap3<K1,K2,K3,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }

    static class SimpleKeyPair<K1,K2,K3> implements KeyPair3<K1,K2,K3> {
        K1 key1;
        K2 key2;
        K3 key3;

        public SimpleKeyPair(K1 key1, K2 key2, K3 key3) {
            this.key1 = key1;
            this.key2 = key2;
            this.key3 = key3;
        }

        public SimpleKeyPair(KeyPair3<K1,K2,K3> kp) {
            this.key1 = kp.getKey1();
            this.key2 = kp.getKey2();
            this.key3 = kp.getKey3();
        }
        ...
        public int hashCode() {
            ...
            key = 31*key + (key3==null ? 0 : key3.hashCode());
     ...
     */
    static class SimpleEntry<K1,K2,K3,V> implements Entry3<K1,K2,K3,V> {
        KeyPair3<K1,K2,K3> kp;
        V value;

        public SimpleEntry(K1 key1, K2 key2, K3 key3, V value) {
            this.kp = new SimpleKeyPair<K1,K2,K3>(key1, key2, key3);
            this.value = value;
        }

        public SimpleEntry(Entry3<K1,K2,K3,V> e) {
            this.kp = new SimpleKeyPair<K1,K2,K3>(e.getKeyPair());
