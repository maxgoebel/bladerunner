...
public interface Map2<K1,K2,V> {
     ...
     */
    void putAll(Map2<? extends K1, ? extends K2, ? extends V> t);
     ...
     */
    Set<Map2.Entry2<K1, K2, V>> entrySet();
    ...
    List<V> getFirstProjection(K1 key1);
    List<V> getSecondProjection(K2 key2);
    List<K1> getAllFirstKeys();
    List<K2> getAllSecondKeys();
    List<K2> getSecondFromFirstKeys(K1 key1);
