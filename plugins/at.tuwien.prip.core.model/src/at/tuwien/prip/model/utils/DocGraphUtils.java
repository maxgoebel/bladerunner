...
public class DocGraphUtils 
{
			...
			ISegmentGraph dg, Rectangle r) 
	{
		...
		return dg.getSubGraph(subNodes, dg.getEdges().size()==0);
	}
	...
	{
		ISegmentGraph sub = DocGraphUtils.getDocumentSubgraphUnderRectangle(g, rect);
		...
		while (iter.hasNext()) 
		{
			...
			if (prev != null)
			{
//				DocEdge de = sub.getEdgeBetween(prev, curr);
//				if (de == null) 
//				{
					...
					else if ((curr.getSegX1() - prev.getSegX2()) > 0.2 * currFontSize)
					{
						sb.append(" ");
					}
//				}
//				else 
//				{
//					double deHLength = de.computeHorizontalDistance();
//					if (deHLength > 0.2 * currFontSize) 
//					{
//						sb.append(" ");
//					}
//				}
			}
			if (curr.getSegText()!=null)
